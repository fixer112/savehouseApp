      ...
      home: Scaffold(
        ...
        body: ListView(
          ...
          children: <Widget>[
            ...
            Text( 'Register', style: TextStyle( fontSize: 27.0, fontWeight: FontWeight.bold ),),
            SizedBox(height: 4),
            Text( 'create a free account and start a proper financial journey with saveHouse capital', style: TextStyle( fontSize: 13, fontWeight: FontWeight.bold ), ),
            SizedBox(height: 30),
            ...
            Text( 'Referrer Phone', style: TextStyle( fontSize: 13, fontWeight: FontWeight.bold ), ),
            Widgets.textField(ref, 'Referrer Phone or Promo Code', TextInputType.phone),
            SizedBox(height: 25),
            ...
            FlatButton(
              ...
              : Text( 'REGISTER', style: TextStyle( fontSize: 12.0, fontWeight: FontWeight.bold ), ),
              onPressed: (){
                setState(() {
                  loading = true;
                });
            ...
            InkWell(
              child: Container(
                ...
                child: Text( 'Already have an account? Login', style: TextStyle( fontSize: 12.0, fontWeight: FontWeight.bold ), ),
              ),
              onTap: (){
