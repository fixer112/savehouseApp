  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text( '8omFfXp3AGG1pO1', style: TextStyle( color: secondaryColor, fontWeight: FontWeight.bold ), ),
        centerTitle: true,
        leading: IconButton(
              ...
              children: <Widget>[
                Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 12,),
                    Text( 'Real Estate Investment', style: TextStyle( fontSize: 15, fontWeight: FontWeight.w700 ), ),
                  ],
                ),
                Text( 'N6,000,000', style: TextStyle( fontSize: 22, fontWeight: FontWeight.w600 ) ),
              ],
            ),
          ),
          Container(
