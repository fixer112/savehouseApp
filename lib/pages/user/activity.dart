                ...
                child: Card(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text( ['You logged in', 'You created an investment', 'You requested withdrawal', 'You canceled an investment plan'][Random.secure().nextInt(4)], style: TextStyle( fontSize: 15 ), ),
                        SizedBox(height: 7,),
                        Container(
